<header class="bg-white shadow-sm" x-data="{ userMenuOpen: false }">
    <div class="flex items-center justify-between px-4 py-3 sm:px-6">
        ...
        <div class="flex-1 mx-4 max-w-md hidden sm:block">
            <div class="relative">
                ...
                <input
                    type="text"
                    class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
        ...
        <div class="flex items-center space-x-4">
            ...
            <div class="relative" @click.away="userMenuOpen = false">
                <button @click="userMenuOpen = !userMenuOpen" class="flex items-center space-x-2 focus:outline-none">
                    ...
                    <span class="hidden md:block">Nome</span>
